...
void DynamixelController::initSubscriber()
{
  ...
  if (is_cmd_vel_topic_) cmd_vel_sub_ = priv_node_handle_.subscribe("/control", 10, &DynamixelController::commandVelocityCallback, this);
}
...
void DynamixelController::commandVelocityCallback(const sensor_msgs::Joy::ConstPtr& msg)
{
  ...
  if (dxl_wb_->getProtocolVersion() == 2.0f)
  {
    if (strcmp(dxl_wb_->getModelName(id_array[0]), "XL-320") == 0)
    {
      ...
      else if (pulses_per_second_1 < 0.0f) dynamixel_velocity[motor_1] = ((-1.0f) * pulses_per_second_1) + 1023;
      else if (pulses_per_second_1 > 0.0f) dynamixel_velocity[motor_1] = (pulses_per_second_1);

      if (pulses_per_second_2 == 0.0f) dynamixel_velocity[motor_2] = 0;
      else if (pulses_per_second_2 < 0.0f)  dynamixel_velocity[motor_2] = ((-1.0f) * pulses_per_second_2 ) + 1023;
      else if (pulses_per_second_2 > 0.0f)  dynamixel_velocity[motor_2] = (pulses_per_second_2 );

      if (pulses_per_second_3 == 0.0f) dynamixel_velocity[motor_3] = 0;
      else if (pulses_per_second_3 < 0.0f)  dynamixel_velocity[motor_3] = ((-1.0f) * pulses_per_second_3 ) + 1023;
      else if (pulses_per_second_3 > 0.0f)  dynamixel_velocity[motor_3] = (pulses_per_second_3 );

      if (pulses_per_second_4 == 0.0f) dynamixel_velocity[motor_4] = 0;
      else if (pulses_per_second_4 < 0.0f)  dynamixel_velocity[motor_4] = ((-1.0f) * pulses_per_second_4 ) + 1023;
      else if (pulses_per_second_4 > 0.0f)  dynamixel_velocity[motor_4] = (pulses_per_second_4 );

    }
    else
    {
      dynamixel_velocity[motor_1]  = pulses_per_second_1;
      dynamixel_velocity[motor_2] = pulses_per_second_2;
      dynamixel_velocity[motor_3]  = pulses_per_second_3;
      dynamixel_velocity[motor_4] = pulses_per_second_4;
